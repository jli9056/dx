 ...
 * 
 */
public class SaveDeliveryAction extends GenericSaveAction<Delivery> {
	public SaveDeliveryAction() {
	...
	public boolean process(HttpServletRequest request, JSONObject result) {
		...
		if (d.getDoubleCheck() == Bool.TRUE || oldDoubleCheck == Bool.TRUE) {
			callAction("saveDoubleCheckedDeliveryAction");
		}
